...
List<_SampleDocument> _sampleInventory() {
  final items = [
    ...
    ('sample_inventory_pakan_lele', 'Pakan Lele', 'Pakan', 'kg', 3.0, 5.0),
    (
      'sample_inventory_media_maggot',
      'Media Maggot Organik',
      'Media',
      'kg',
      24.0,
      12.0,
    ),
    ('sample_inventory_kompos', 'Kompos Matang', 'Pupuk', 'kg', 45.0, 20.0),
    (
      'sample_inventory_bibit_sayur',
      'Bibit Tanaman Sayur',
      'Bibit',
      'tray',
      7.0,
    ...
    (
      'sample_inventory_probiotik_lele',
      'Probiotik Lele',
      'Suplemen',
      'botol',
      4.0,
    ...
    ('sample_inventory_sekop', 'Sekop Kebun', 'Alat Kebun', 'unit', 5.0, 2.0),
    (
      'sample_inventory_selang_air',
      'Selang Air',
      'Alat Kebun',
      'unit',
      2.0,
